...
#[ApiResource(
    ...
    denormalizationContext: ['groups' => ['user:write', 'reservation:write']]
)]
...

{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(['user:read', 'enrollment:read', 'reservation:read', 'reservation:write', 'log:read'])]
    private ?int $id = null;
     ...
     */
    #[ORM\OneToMany(mappedBy: 'user', targetEntity: Reservation::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
